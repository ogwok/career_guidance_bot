...
export default function Home() {
    ...
    return (
        <div className="max-w-[100%] md:max-w-[50%] mx-auto h-screen relative flex flex-col">
            ...
            <div className="w-[90%] md:w-[60%] h-20 fixed bottom-0 left-1/2 -translate-x-1/2 flex items-center justify-center">
                <form onSubmit={handleSubmit} className="w-full">
                    <input
                        ...
                        className="w-full p-2 border rounded bg-[#686868] outline-none"
                        placeholder="Feeling stuck? Let's chat about your career..." 
                        disabled={typing}
                    />
                </form>
            </div>
